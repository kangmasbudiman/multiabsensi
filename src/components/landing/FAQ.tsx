...
export function FAQ({ t }: Props) {
  ...
  return (
    <section id="faq" className="py-20 sm:py-28 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-3xl mx-auto px-5 sm:px-8">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:-translate-y-0.5 transition-all"
          >
...
function FAQRow({ item, delay }: { item: FAQItem; delay: number }) {
  ...
  return (
    <div
      ...
      className={`reveal ${visible ? 'is-visible' : ''} group rounded-xl border border-slate-200 bg-white overflow-hidden hover:border-teal-200 transition-colors`}
    >
      <details className="group">
        <summary className="flex items-center justify-between gap-3 px-5 py-4 cursor-pointer list-none select-none">
          ...
          <div className="w-7 h-7 rounded-full bg-slate-100 group-hover:bg-teal-100 flex items-center justify-center transition-colors">
